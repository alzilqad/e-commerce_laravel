...
class CreatePWeightClassesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('p_weight_classes', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('name_en', 50);
            $table->string('name_bn', 50);
            $table->string('unit', 10)->comment('kg, gm');
    ...
    {
        Schema::dropIfExists('p_weight_classes');
    }
}
